...
// ----------->
 ...
 const AdminAuth = ({ onSignIn, onClose }) => {
    ...
    <section
      ...
      {/* header end */}
        ...
        <div className="container mx-auto py-6">
          <div className="w-1/2 mx-auto bg-white shadow-md rounded-lg p-10">
            <p className="mb-6">
            ...
            <form action="" onSubmit={submitForm}>
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div>
                  <p className="text-red-600 hover:text-[gold] text-sm"> <Link to='/forgottenPassword' >I Forgot my password </Link> </p>
                </div>
              </div>

              <button type="submit" className="w-full bg-[gold] border-[gold] text-black hover:scale-105 py-2 rounded-lg hover:text-white " onClick={() => {
              ...
              <p className="text-center mt-4 cursor-pointer text-[red] hover:text-[gold] " onClick={() => {
      ...
      <AdminPopup isOpen={isPopupOpen} onClose={closePopup}>
