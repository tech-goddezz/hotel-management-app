...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className="font-georgia max-w-[1520px] mx-auto flex justify-between items-center text-[#aaa9a9] z-index-999 p-1  sticky  bg-[#222222] top-0 z-50 h-[15vh] ">
                ...
                <div className="flex items-center">
                    <ul className='text-[#cfcfcf]  max-w-[1520px] mx-auto flex justify-between items-center p-10 sm:w[400px] lg:[500px]'>
                        <li className='p-3 flex items-center text-bold transition-all duration-200 ease-out mr-30 hover:text-[#ebcf32]'>
                        <NavLink to='/loginChoice' className='mr-1' onClick={closeMobileMenu}
                        activeClassName="active-link">
                                Login
                            </NavLink>    
                        </li>
            ...
            <div className={sideNav ?
                "fixed font-georgia top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300"
                ...
                <nav className='flex flex-col p-4 text-gray-900'>
                    <ul>
                        <li className="text-xl hover:text-[gold] hover:scale-105 py-4 flex">
                            <BsPerson
                                size={25}
                                className='mr-4 text-white bg-[gold] rounded-full'
                            />
                            My Account
                        </li>
